...
<tileset version="1.10" tiledversion="1.11.2" name="blood pool - standard style - with spikes" tilewidth="32" tileheight="32" tilecount="310" columns="31">
 <image source="../PrisonArt/Tilesets/blood pool-standard style - with spikes.png" width="992" height="320"/>
 <tile id="33">
